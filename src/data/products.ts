...
export const products: Product[] = [
  // Jeans
  {
    ...
    images: ["/images/products/b1.jpg", "/images/products/b3.jpg"],
    category: "jeans",
    brand: "Fashion Hero",
    size: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    images: ["/images/products/j2.jpg", "/images/products/j3.jpg"],
    category: "jeans",
    brand: "Urban Classic",
    size: ["M", "L"],
    color: ["Grey"],
  ...
  },
  {
    ...
    images: ["/images/products/j5.jpg", "/images/products/j6.jpg"],
    category: "jeans",
    brand: "Denim Pro",
    size: ["S", "M", "L", "XL", "XXL"],
    color: ["Black"],
  ...
  // Hoodies
  {
    ...
    images: ["/images/products/ph2.jpg", "/images/products/ph3.jpg"],
    category: "hoodie",
    brand: "CozyWear",
    size: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    images: ["/images/products/zh2.jpg", "/images/products/zh3.jpg"],
    category: "hoodie",
    brand: "Urban Fit",
    size: ["M", "L", "XL"],
    color: ["Navy", "Black"],
  ...
  },
  {
    ...
    images: ["/images/products/gp1.jpg", "/images/products/gp3.jpg"],
    category: "hoodie",
    brand: "GraphiStyle",
    size: ["S", "M", "L"],
    color: ["White", "Black"],
  ...
  // Shirts
  {
    ...
    images: ["/images/products/wh1.jpg", "/images/products/wh3.jpg"],
  ...
  },
  {
    ...
    images: ["/images/products/ch2.jpg", "/images/products/ch3.jpg"],
    category: "shirts",
    brand: "Fashion Hero",
    size: ["M", "L", "XL"],
    color: ["Red", "Blue"],
  ...
  },
  {
    ...
    images: ["/images/products/el2.jpg", "/images/products/el3.jpg"],
    category: "shirts",
    brand: "Natural Vibe",
    size: ["M", "L"],
    color: ["Beige"],
  ...
  },
  {
    ...
    images: ["/images/products/cl2.jpg", "/images/products/cl3.jpg"],
    category: "shorts",
    brand: "Utility Mode",
    size: ["S", "M", "L"],
    color: ["Khaki", "Olive"],
  ...
  },
  {
    ...
    images: ["/images/products/ath2.jpg", "/images/products/ath3.jpg"],
    category: "shorts",
  ...
  // T-Shirts
  {
    ...
    images: ["/images/products/t2.jpg", "/images/products/t3.jpg"],
    category: "tshirts",
    brand: "Fashion Hero",
    size: ["S", "M", "L", "XL"],
    color: ["Black"],
  ...
  },
  {
    ...
    images: ["/images/products/gp2.jpg", "/images/products/gp3.jpg"],
    category: "tshirts",
    brand: "GraphiStyle",
    size: ["M", "L"],
    color: ["White", "Grey"],
  ...
  },
  {
    ...
    images: ["/images/products/oz1.jpg", "/images/products/oz3.jpg"],
    category: "tshirts",
    brand: "Relax Fit",
    size: ["L", "XL", "XXL"],
    color: ["Beige", "Sage"],
