...
export default function SearchResultsPage() {
  ...
  PaperProps={{
    className: "bg-gradient-to-b from-gray-50 to-white shadow-xl" // Added shadow
  }}
>
  <motion.div
    ...
    {popupProduct && (
      <DialogContent className="p-6">
        <div className="mt-4 flex flex-col sm:flex-row gap-6 items-start">
          {/* Product Image - Larger and with better spacing */}
          ...
          <div className="sm:w-2/3 space-y-3">
            ...
            <p className="text-2xl font-bold text-green-600">
              ₹{popupProduct.price.toLocaleString()}
            </p>
              ...
              {popupProduct.size && (
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium">
                    {Array.isArray(popupProduct.size) ? popupProduct.size.join(", ") : popupProduct.size}
                  </span>
                </div>
              )}
            </div>
